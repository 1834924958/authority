...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/TP3jc/Public/Admin/Login/css/login.css" media="all">
    <link rel="stylesheet" type="text/css" href="/TP3jc/Public/Admin/Login/css/default_color.css" media="all">
</head>
<body id="login-page">
<div id="main-content">
...
<script type="text/javascript">
    ...
    var bg = 'url(/TP3jc/Public/Admin/Login/images/bg_' + random_bg + '.jpg)';
